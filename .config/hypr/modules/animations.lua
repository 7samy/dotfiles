...
-- Benutzerdefinierte Bezier-Kurven definieren
...
hl.animation({ leaf = "windowsMove", enabled = true, speed = 6, bezier = "myBezier" })
...
-- Workspace-Animationen
hl.animation({ leaf = "workspaces", enabled = true, speed = 7, bezier = "menu_decel", style = "slide" })

-- Special-Workspace-Animationen
...
-- Dwindle-Layout-Einstellungen (KORREKT: in hl.config())


-- Master-Layout-Einstellungen (KORREKT: in hl.config())
hl.config({
  master = {
    new_status = "master",
  },
